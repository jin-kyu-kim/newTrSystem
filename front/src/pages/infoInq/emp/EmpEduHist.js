...
import EmpEduHistJson from "./EmpEduHistJson.json";
...
const EmpEduHist = ({ callBack, props }) => {
  ...
  const {queryId, keyColumn, tableColumns } = EmpEduHistJson;
        ...
        <div style={{ width: "95%", height: "180px", backgroundColor: "#fff" }}>
          ...
          <Box direction="row" width="100%" height={40}>
            <Item className="prjctNameItem" ratio={1}>
              <CustomCdComboBox param="VTW001" placeholderText="교육기관" name="jbpsNm" onSelect={handleChgState} value={initParam.jbpsNm} />
            </Item>
            <Item className="prjctNameItem" ratio={1}>
              <CustomCdComboBox param="VTW002" placeholderText="교육명" name="deptNm" onSelect={handleChgState} value={initParam.deptNm} />
            </Item>
            <Item className="ctmmnyNameItem" ratio={1}>
              <TextBox placeholder="교육기간" stylingMode="filled" size="large" name="telNo" onValueChanged={(e) => handleChgState({ name: e.component.option("name"), value: e.value })} />
            </Item>
            <Item className="prjctNameItem" ratio={1}>
              <TextBox placeholder="교육내용" stylingMode="filled" size="large" name="telNo" onValueChanged={(e) => handleChgState({ name: e.component.option("name"), value: e.value })} />
            </Item>
          </Box>
