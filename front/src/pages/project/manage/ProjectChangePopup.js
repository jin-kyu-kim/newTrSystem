...
const ProjectChangePopup = ({selectedItem, period, popupInfo, prjctId, bgtMngOdrTobe, ctrtYmd, stbleEndYmd, transformedData, targetOdr, bizSttsCd, atrzLnSn}) => {
    ...
    const handleCancel = (e) => {
        navigate("../project/ProjectChange",
            {
        state: { prjctId: prjctId, bgtMngOdrTobe: bgtMngOdrTobe, ctrtYmd: ctrtYmd, stbleEndYmd: stbleEndYmd, targetOdr, bizSttsCd, atrzLnSn},
        })
    };
