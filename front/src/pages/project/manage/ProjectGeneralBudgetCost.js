...
import CustomComplexAddTable from "../../../components/unit/CustomComplexAddTable";
import Box, {Item} from "devextreme-react/box";
import ApiRequest from "../../../utils/ApiRequest";

const ProjectGeneralBudgetCost = (data) => {
    const [values, setValues] = useState([]);
    const { manuName, tableColumns, keyColumn} = ProjectGeneralBudgetCostJson;
